...
// Area ID
const byte S7AreaPE   =	0x81; //I
const byte S7AreaPA   =	0x82; //Q
const byte S7AreaMK   =	0x83; //M
const byte S7AreaDB   =	0x84; //DB/V
const byte S7AreaCT   =	0x1C; //CT
const byte S7AreaTM   =	0x1D; //TM
...
// See 搂33.1 of "System Software for S7-300/400 System and Standard Functions"
...
// See 搂33.19 of "System Software for S7-300/400 System and Standard Functions"
typedef struct {
   word  sch_schal;
   word  sch_par;
   word  sch_rel;
